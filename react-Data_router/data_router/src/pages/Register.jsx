...
const Register = () => {
  const {handleSubmit,registerData,navigate,errors,register} = useAuth()
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
      <div className="w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-3xl p-8 shadow-xl">
        ...
        <p className="text-zinc-400 text-center mb-8">Register to continue</p>
        ...
        <form onSubmit={handleSubmit(registerData)} className="space-y-5">
          ...
          <div>
            ...
            />
            {errors.name && (
              <p className="text-red-600">{errors.massage.name}</p>
            )}
          </div>
